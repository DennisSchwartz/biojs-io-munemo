...
var Munemo = function ( input ) {
    ...
    if ( fields !== undefined && fields !== "") {
        ...
        for (i = 0; i < fields.length; i++) {
            if (fields[i] === ( Options.sourceFieldLabel || 'source' || 'source_name' )) sourceIndex = i;
            if (fields[i] === ( Options.targetFieldLabel || 'target' || 'target_name' )) targetIndex = i;
    ...
    var calcVertexDegrees = function (step, done) {
